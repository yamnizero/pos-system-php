            ...
            <form action="code.php" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="name" value="<?=$category['data']['name']?>" require class="form-control" />
                    </div>
                    <div class="col-md-12 mb-3">
                    ...
                    <div class="col-md-6 mb-3 text-end">
                        <br>
                        <button type="submit" name="updateCategory" class="btn btn-primary">Upadate</button>
                    </div>
                </div>
                <?php
                 } else {
