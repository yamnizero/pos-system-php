    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header">
            <h4 class="mb-0">Order View
                <a href="orders-view-print.php?track=<?=$_GET['track']?>" class="btn btn-info mx-4 btn-sm float-end">Print</a>
                <a href="orders.php" class="btn btn-danger mx-4 btn-sm float-end">Back</a>
            </h4>
        </div>
        <div class="card-body">
                  ...
                  if($_GET['track'] == ''){
                    ?>
                        <div class="text-center py-5">
                            <h5>No Tarcking Number Found</h5>
                            <div>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach ($orderItemsRes as $orderItemRow) : ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?= $orderItemRow['image'] != '' ? '../' . $orderItemRow['image'] : '../assets/images/no-img.jpg'; ?>" style="width:50px;height:50px;" alt="Img" />
                                                    <?= $orderItemRow['name'] ?>
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="text-end fw-bold">Ra: <?= number_format($orderItemRow['total_amount'], 0) ?></td>
